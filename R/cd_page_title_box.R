...
#'
#' Generates 'asis' LaTeX code to create a title page with a box color in the front
#' page.
#'
#' @param title Character. Document title. Default title parameter in yml.
#' Use this parameter to specify a title
#' different from the title in the yml header of the document.
#' @param subtitle Character. Document subtitle. Default subtitle parameter in yml.
#' Use this parameter to specify a subtitle
#' different from the subtitle in the yml header of the document.s
...
#' @param subtitle_below Character. Document subtitle. Use this parameter to specify a subtitle
