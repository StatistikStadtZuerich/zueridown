...
Generates 'asis' LaTeX code to create a title page with a box color in
the front page.
...
- subtitle:
  ...
  the yml header of the document.s
...
- subtitle_below:
  ...
  Character. Document subtitle. Use this parameter to specify a subtitle
